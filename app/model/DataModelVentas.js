Ext.define('sisbotica_paulino.model.DataModelVentas', {extend: 'Ext.data.Model',fields: [{ name: 'id', type: 'int' }]});

// @Model : Producto
Ext.define('sisbotica_paulino.model.ProductoPorCliente', {
...
// @Model : Cliente
Ext.define('sisbotica_paulino.model.Cliente', {
    extend: 'Ext.data.Model',
    fields: [
        { name: 'idper', type: 'int' },
...
Ext.define('sisbotica_paulino.model.TipoDocumento', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('sisbotica_paulino.model.TipoDocumentoVenta', {
    extend: 'Ext.data.Model',
    fields: [
        { name: 'id', type: 'int' },
        { name: 'descripcion', type: 'string' },
...
Ext.define('sisbotica_paulino.model.Cotizacion', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('sisbotica_paulino.model.CotizacionDetalle', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('sisbotica_paulino.model.FormaPago', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('sisbotica_paulino.model.ModoEntrega', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('sisbotica_paulino.model.Vendedor', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('sisbotica_paulino.model.UnidadMedida', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('sisbotica_paulino.model.Presentacion', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('sisbotica_paulino.model.EstProducto', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('sisbotica_paulino.model.DetFacturacion', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('sisbotica_paulino.model.DetalleIngresoGuiaVista', {
    extend: 'Ext.data.Model',
    fields: [
...
// @Model Detalle de ingreso al almacen , muestra todos los ingresos de una orden de compra
Ext.define('sisbotica_paulino.model.MotivoTranslado', {
    extend: 'Ext.data.Model',
    fields: [
      {name: "id", type:'int' },
      {name: "descripcion", type:'string' },
...
Ext.define('sisbotica_paulino.model.TiendaDocumentoVentaAsignado', {
    extend: 'Ext.data.Model',
    fields: [
      {name: "id", type:'int' },
...
Ext.define('sisbotica_paulino.model.TiendaDocumentoVenta', {
    extend: 'Ext.data.Model',
    fields: [
      {name: "id", type:'int' },
      {name: "documentoventa", type:'string' }
...
Ext.define('sisbotica_paulino.model.TiendaTicketeraAsignada', {
    extend: 'Ext.data.Model',
    fields: [
      {name: "id", type:'int' },
...
Ext.define('sisbotica_paulino.model.TiendaTicketera', {
    extend: 'Ext.data.Model',
    fields: [
      {name: "id", type:'int' },
      {name: "ticketera", type:'string' }
...
Ext.define('sisbotica_paulino.model.MetodoPago', {
    extend: 'Ext.data.Model',
    fields: [
      {name: "id", type:'int' },
      {name: "descripcion", type:'string' },
...
Ext.define('sisbotica_paulino.model.AperturaCaja', {
    extend: 'Ext.data.Model',
    fields: [
      {name: "id", type:'int' },
      {name: "descripcion", type:'string' },
...
Ext.define('sisbotica_paulino.model.AperturaCajaHis', {
    extend: 'Ext.data.Model',
    fields: [
      {name: "id", type:'int' },
      {name: "comentario", type:'string' },
