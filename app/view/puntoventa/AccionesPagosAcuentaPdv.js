Ext.define('sisbotica_paulino.view.ventas.AccionesPagosAcuentaPdv', {
    ...
    onClickGuardarPagoAcuenta:function(btn){
      ...
      if(__store){
        ...
        Ext.Ajax.request({
            url :sisbotica_paulino.util.Rutas.facturacionAgregarPagosAcuenta,
            params:{
            ...
            success:function(response){
                  ...
                  if(__data.error!=0){
                    sisbotica_paulino.util.Util.showToast('Registrado');
                    __view.close();
