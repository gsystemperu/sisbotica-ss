Ext.define('sisbotica_paulino.view.puntoventa.ListadoPdv', {
    ...
    requires: [
        ...
        'Ext.form.field.*',
        'Ext.panel.Panel',
        'sisbotica_paulino.view.puntoventa.AccionesListadoPdv',
    ...
    initComponent: function () {
        var storeCotiFacturar    = Ext.create('sisbotica_paulino.store.PuntoVentaPagos');
