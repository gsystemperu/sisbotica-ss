Ext.define('sisbotica_paulino.view.puntoventa.AperturaCaja', {
    ...
    requires   : [
        ...
        'Ext.grid.*',
        'sisbotica_paulino.view.puntoventa.AccionesAperturaCaja'
    ],
    config : {
        nombre : '',
        monto  : 0,
    ...
    {
        me = this;
        st = Ext.create('sisbotica_paulino.store.NombreMoneda');
        sh = Ext.create('sisbotica_paulino.store.ListaAperturaCajaHistorico');
        Ext.apply(me,
        {
          items :[ 
              {
