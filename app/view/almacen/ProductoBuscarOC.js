Ext.define('sisbotica_paulino.view.almacen.ProductoBuscarOC', {
    ...
    initComponent:function(){
        me = this;
        storeProducto  = Ext.create('sisbotica_paulino.store.ProductosOrdenCompra');
        storeProducto.load({
          params:{
            idprov : me.getProveedor()
          }
        });
        storeTipoProd  = null; //Ext.create('sisbotica_paulino.store.TipoDeProductos');
        Ext.apply(me,{
            items:[
