Ext.define('sisbotica_paulino.view.almacen.Almacenes', {
  extend: 'Ext.panel.Panel',
  xtype: 'wRegAlmacen',
  alias: 'widget.wRegAlmacen',
  requires: [
    'Ext.layout.container.HBox',
    'sisbotica_paulino.view.almacen.AccionesAlmacen',
    'Ext.grid.*',
  ...
  initComponent: function () {
    me = this;
      store = Ext.create('sisbotica_paulino.store.Almacenes');
    Ext.apply(this, {
      items: [
  ...
  getPanelAlmacen: function (store) {
    ...
    var obj = {
      ...
      items: [{
       ...
       url: sisbotica_paulino.util.Rutas.almacenGuardar,
        flex: 1,
        layout: {
          type: 'vbox',
          pack: 'start',
  ...
  getPanelAlmacenSession: function (storealmacen) {
    store = Ext.create('sisbotica_paulino.store.AlmacenSecciones');
    var obj = {
      xtype: 'panel',
      flex: 1.5,
      items: [{
        ...
        url : sisbotica_paulino.util.Rutas.seccionAlmacenGuardar,
        flex: 1,
        layout: {
          type: 'vbox',
          pack: 'start',
