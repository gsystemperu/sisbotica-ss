Ext.define('sisbotica_paulino.view.almacen.ListadoInventario',{
    extend: 'Ext.panel.Panel',
    xtype: 'wListadoInventario',
    alias: 'widget.wListadoInventario',
    requires: [
      'Ext.layout.container.HBox',
      'sisbotica_paulino.view.almacen.ListadoInventarioController',
      'Ext.grid.*',
      'Ext.form.field.*',
      'Ext.grid.plugin.*'
    ],
    ...
    initComponent: function () {
      var st = Ext.create('sisbotica_paulino.store.InventarioRegistros');
