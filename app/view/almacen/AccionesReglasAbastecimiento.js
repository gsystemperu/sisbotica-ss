...
Ext.define('sisbotica_paulino.view.almacen.AccionesReglasAbastecimiento', {
    ...
    onClickIngresar:function(){
        Ext.create('sisbotica_paulino.view.almacen.IngresarAbastecimiento');
    },
    onClickBuscarProducto:function(btn){
        Ext.create('sisbotica_paulino.view.almacen.ProductoBuscar');
    },
    ...
    onClickFormularioProveedor :function(btn){
        var win   = Ext.create('sisbotica_paulino.view.almacen.FormProveedor',{control: btn.control.toString()});
    },
