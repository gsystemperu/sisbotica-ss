...
Ext.define('sisbotica_paulino.view.almacen.AccionesUbicacion', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.acciones-ubicacion',
    requires:['sisbotica_paulino.util.Rutas','sisbotica_paulino.util.Util'],
    ...
    onClickGuardarUbicacion:function(){
        ...
        Ext.Ajax.request({
            url :sisbotica_paulino.util.Rutas.productoGuardarUbicacion,
            params:{
            ...
            success:function(response){
               var rs = sisbotica_paulino.util.Util.decodeJSON(response.responseText);
               if(rs.error>0){
                 me.getView().unmask();
