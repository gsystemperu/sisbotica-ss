Ext.define('sisbotica_paulino.view.almacen.ProductoBuscar', {
    ...
    initComponent:function(){
        me = this;
        storeProducto  = Ext.create('sisbotica_paulino.store.Productos');
        storeTipoProd  = Ext.create('sisbotica_paulino.store.TipoDeProductos');
        Ext.apply(me,{
            items:[
