...
Ext.define('sisbotica_paulino.view.almacen.ProductoUbicacion', {
    extend: 'Ext.window.Window',
    xtype:'wProductoUbicacion',
    requires:['sisbotica_paulino.view.almacen.AccionesUbicacion'],
    modal:true,
    ...
    getItems:function(codigoserie){
      storeA = Ext.create('sisbotica_paulino.store.Almacenes');
      storeS = Ext.create('sisbotica_paulino.store.AlmacenSecciones');
      return obj = [
        {
            xtype: 'container',
            scrollable: true,
