Ext.define('sisbotica_paulino.view.almacen.IngresarAbastecimiento', {
    extend: 'Ext.window.Window',
    xtype: 'wingresarabastecimiento',
    requires: [
        'Ext.grid.plugin.*',
        'sisbotica_paulino.view.almacen.AccionesReglasAbastecimiento',
    ...
    initComponent: function () {
        ...
        var storeTipoDoc      = Ext.create('sisbotica_paulino.store.TipoDocumento');
        var storeProveedores = Ext.create('sisbotica_paulino.store.Proveedores');
        var storeDetalle      = Ext.create('sisbotica_paulino.store.DetalleAbastecimiento');
        me = this;
        Ext.applyIf(me, {
            items: [{
                    xtype: "form",
                    ...
                    url: sisbotica_paulino.util.Rutas.abastecimientoGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
