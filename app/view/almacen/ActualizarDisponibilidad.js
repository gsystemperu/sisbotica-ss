Ext.define('sisbotica_paulino.view.almacen.ActualizarDisponibilidad',{
    extend: 'Ext.window.Window',
    alias : 'widget.wActDisponibilidad',
    xtype : 'wActDisponibilidad',
    itemId : 'wActDisponibilidad',
    requires: [
        'sisbotica_paulino.view.almacen.ActualizarDisponibilidadController',
    ],
    autoShow:true,
    width : 700,
    height: 180,
    ...
    items:[
        {
            ...
            reference : 'frmdispo',
            itemId : 'frmdispo',
            url : sisbotica_paulino.util.Rutas.productoActualizarCantidad,
            layout:{
                type:'vbox',
                pack: 'start',
                align: 'stretch'
