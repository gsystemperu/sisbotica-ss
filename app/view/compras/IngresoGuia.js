Ext.define('sisbotica_paulino.view.compras.IngresoGuia', {
  ...
  initComponent: function () {
    var storeOrdenCompraConfirmdaDet = Ext.create('sisbotica_paulino.store.TmpOrdenCompraConfirmadas');
  ...
  getDatosDelProveedor: function () {
    return obj = {
      ...
      url: sisbotica_paulino.util.Rutas.guiaProveedorGuardar,
      layout: 'hbox',
      padding: 5,
      bodyPadding: 5,
      defaults: {
