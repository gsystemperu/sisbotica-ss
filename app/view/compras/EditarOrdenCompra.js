Ext.define('sisbotica_paulino.view.compras.EditarOrdenCompra', {
    extend: 'Ext.panel.Panel',
    xtype: 'weditarordencompra',
    requires: [
        'Ext.grid.plugin.*',
        'sisbotica_paulino.view.compras.AccionesOrdenCompraEditar',
    ...
    initComponent: function () {
        ...
        var storeDetalle = Ext.create('sisbotica_paulino.store.DetalleOrdenCompra');
            ...
            items: [
                {
                    ...
                    url: sisbotica_paulino.util.Rutas.ordenCompraEditar,
                    items: [{
                        xtype: 'panel',
                        flex: 1,
                        frame: false,
