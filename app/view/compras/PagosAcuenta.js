Ext.define('sisbotica_paulino.view.compras.PagosAcuenta', {
    ...
    requires   : [
        ...
        'Ext.grid.*',
        'sisbotica_paulino.view.compras.AccionesPagosAcuenta'
    ...
    {
        me = this;
        s = Ext.create('sisbotica_paulino.store.PagosAcuenta');
        m = Ext.create('sisbotica_paulino.store.MetodosPago');
        ...
        Ext.Ajax.request({
              url : sisbotica_paulino.util.Rutas.ordenCompraBuscarPagoAcuenta,
              params:{
...
/*Ext.define('sisbotica_paulino.view.compras.PagosAcuenta', {
    ...
    {
        me = this;
        __store = Ext.create('sisbotica_paulino.store.PagosAcuenta');
        me.title = me.getNombre();
        Ext.apply(me,
        {
