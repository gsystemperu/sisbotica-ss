Ext.define('sisbotica_paulino.view.compras.ContenedorGuias', {
  ...
  requires: [
    ...
    'sisbotica_paulino.view.compras.AccionesContenedorGuias',
    'sisbotica_paulino.view.compras.IngresoGuia',
  ...
  mostrarIngresoGuias: function () {
    ...
    if(_rec){
       ...
       _store.removeAll();
       Ext.Ajax.request({
           url : sisbotica_paulino.util.Rutas.OrdenCompraConfirmadaDetalle,
           params:{
             id :  _rec.get('id')
           },
           success:function(response){
              _data = sisbotica_paulino.util.Util.decodeJSON(response.responseText);
              _id   = 0;
