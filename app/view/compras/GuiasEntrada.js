Ext.define('sisbotica_paulino.view.compras.GuiasEntrada', {
  ...
  requires: [
    ...
    'sisbotica_paulino.view.compras.AccionesGuia',
    'Ext.grid.plugin.*'
  ],
  layout: {
    type: 'vbox',
  ...
  initComponent: function () {
    var storeOrdenCompraConfirmada = Ext.create('sisbotica_paulino.store.OrdenesCompraConfirmadas');
    var storeProveedores = Ext.create('sisbotica_paulino.store.Proveedores');
    var storeOrdenCompraConfirmdaDet = Ext.create('sisbotica_paulino.store.DetalleIngresoGuiaVista');
