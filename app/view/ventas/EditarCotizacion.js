Ext.define('sisbotica_paulino.view.ventas.EditarCotizacion', {
    ...
    initComponent: function () {
        ...
        me = this;
        var storeClientes = Ext.create('sisbotica_paulino.store.Clientes');
        var storeProductos = Ext.create('sisbotica_paulino.store.Productos');
        //var storeDetCot = Ext.create('sisbotica_paulino.store.CotizacionesDetalle');
        var storeDetCotizacion = Ext.create('sisbotica_paulino.store.DetalleCotizacion');
        var storeFormaPago = Ext.create('sisbotica_paulino.store.FormaPago');
        var storeModoEntrega = Ext.create('sisbotica_paulino.store.ModoEntrega');
        var storeVendedores = Ext.create('sisbotica_paulino.store.Vendedores');
        storeClientes.load();
        ...
        Ext.applyIf(me, {
            items: [{
                    ...
                    url: sisbotica_paulino.util.Rutas.cotizacionGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
                            ...
                            items: [{
                                ...
                                },
                                {
                                    ...
                                    buttons: [{
                                            ...
                                            text: 'Cancelar',
                                            scale: 'medium',
                                            glyph: sisbotica_paulino.util.Glyphs.getGlyph('cancelar'),
