Ext.define('sisbotica_paulino.view.ventas.VisorVendedorCotizacion', {
    ...
    getItems: function () {
        var storeVendedor = Ext.create('sisbotica_paulino.store.Vendedores');
        var storeEstadistica = Ext.create('sisbotica_paulino.store.CotizacionesEstadisticaVendedor');
        var obj = [{
                xtype: 'container',
                flex: 0.8,
                layout: {
