Ext.define('sisbotica_paulino.view.ventas.RegistrarCliente', {
    ...
    initComponent: function() {
        var storeTipoDoc = Ext.create('sisbotica_paulino.store.TipoDocumentos');
        me = this;
        Ext.apply(me, {
            items: [
                {
                    ...
                    url : sisbotica_paulino.util.Rutas.clienteGuardar,
                    bodyPadding: 5,
                    layout: {
                        type: 'hbox',
                        align: 'stretch'
