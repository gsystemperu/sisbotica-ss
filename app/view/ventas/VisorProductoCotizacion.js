Ext.define('sisbotica_paulino.view.ventas.VisorProductoCotizacion', {
    ...
    getItems: function () {
        ...
        var storeEstadistica = Ext.create('sisbotica_paulino.store.CotizacionesEstadisticaProducto');
        var obj = [{
                xtype: 'container',
                flex: 0.8,
                layout: {
