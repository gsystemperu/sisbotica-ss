Ext.define('sisbotica_paulino.view.ventas.AccionesContenedorCotizacionesFacturar',{
    ...
    onClickDocumentoImprimir:function(btn){
      try {
          ...
          //if(_record.get('idguia')>0){
            ...
            //var objrpt = window.open( sisbotica_paulino.util.Rutas.rptImprimirNota+
    ...
    onClickGuiasRemisionImpresion:function(btn){
      try {
          var _record =  Ext.ComponentQuery.query('#dgvVentasFacturar')[0].getSelectionModel().getSelection()[0];
          if(_record.get('idguia')>0){
            var objrpt = window.open( sisbotica_paulino.util.Rutas.rptImprimirGuiaRemision+
      ...
      try {
             ...
             _record.get('idguia') == 0 )
        {
          ...
          if(_record.get('idfacturacion')==0){
            ...
            Ext.Ajax.request({
              url : (_record.get('idfacturacion')==0?sisbotica_paulino.util.Rutas.cotizacionDetalle:sisbotica_paulino.util.Rutas.facturacionDetalle),
              params:{
                vIdCotizacion : _record.get('idcoti')
              },
              method : 'GET',
