Ext.define('sisbotica_paulino.view.ventas.GuiaRemision', {
    ...
    requires: [
        ...
        'sisbotica_paulino.view.ventas.AccionesGuiaRemision'
    ],
    itemId: 'wGuiaRemision',
    controller: 'acciones-guiaremision',
    initComponent: function () {
        me = this;
        __storeGuiaRemisionDetalle = Ext.create('sisbotica_paulino.store.GuiaRemisionDetalle');
        __storeMotivosTranslado = Ext.create('sisbotica_paulino.store.MotivosTranslados');
        Ext.applyIf(me, {
            items: [
                {
                    xtype: "form",
                    ...
                    url: sisbotica_paulino.util.Rutas.guiaRemisionActualizar,
                    items: [
                        {
                            xtype: 'panel',
                            border: false,
