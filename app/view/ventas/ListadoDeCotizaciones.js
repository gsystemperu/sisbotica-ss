Ext.define('sisbotica_paulino.view.ventas.ListadoDeCotizaciones', {
    ...
    initComponent: function () {
        var storeCoti    = Ext.create('sisbotica_paulino.store.Cotizaciones');
        var storeCotiDet = Ext.create('sisbotica_paulino.store.CotizacionesDetalle');
        var storeEstado = Ext.create('sisbotica_paulino.store.BusquedaEstado');
