Ext.define('sisbotica_paulino.view.ventas.AccionesRegCotizacion', {
    ...
    onClickBuscarProducto: function (btn) {
      if(Ext.ComponentQuery.query('#cboDatosCliente')[0].getValue()){
        var _win = Ext.create('sisbotica_paulino.view.ventas.BuscarProducto', { cliente: Ext.ComponentQuery.query('#cboDatosCliente')[0].getValue()});
