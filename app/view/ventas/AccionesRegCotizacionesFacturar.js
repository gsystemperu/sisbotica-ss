Ext.define('sisbotica_paulino.view.ventas.AccionesRegCotizacionesFacturar', {
    ...
    onClickMantenimiento: function () { _win = Ext.create('sisbotica_paulino.view.ventas.Mantenimiento');},
    onClickNuevoCliente:function(){ _win = Ext.create('sisbotica_paulino.view.ventas.RegistrarCliente');_win.show(btn, function () {}, this);},
    onClickGuardarCotizacionFacturar:function(){
       ...
       if (_form.isValid()) {
           ...
           sisbotica_paulino.util.Util.showErrorMsg('Ingresar los datos para la facturacion!');
       }
    },
      ...
      try {
        if (record)
        {
          ...
          switch (record.get('estado')) {
              ...
              case 1: u=sisbotica_paulino.util.Rutas.facturacionDetalle; break;
    ...
    onSelectedDetalleFacturacionVenta:function(grid, td, cellIndex, record, tr, rowIndex, e, eOpts)
    {
        ...
        //  }
          if(record.get('idfacturacion')>0)
          {
            ...
            /*__storeFactDet = Ext.create('sisbotica_paulino.store.DetalleFacturacion');
            ...
            Ext.Ajax.request({
                url : sisbotica_paulino.util.Rutas.facturacionDetalle,
                params:{
                  idfacturacion : record.get('idfacturacion')
                },
                success:function(response){
