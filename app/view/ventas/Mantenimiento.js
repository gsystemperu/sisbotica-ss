Ext.define('sisbotica_paulino.view.ventas.Mantenimiento', {
    ...
    requires: [
        ...
        'Ext.toolbar.Toolbar',
        'Ext.form.Panel',
        'sisbotica_paulino.view.ventas.AccionesMantenimiento'
    ],
    autoShow: true,
    width: 900,
    height: 400,
    ...
    getItems: function () {
        var storeUM = Ext.create('sisbotica_paulino.store.UnidadMedida');
        var storeME = Ext.create('sisbotica_paulino.store.ModoEntrega');
        var storeFP = Ext.create('sisbotica_paulino.store.FormaPago');
        var storeVE = Ext.create('sisbotica_paulino.store.Vendedores');
        var storePR = Ext.create('sisbotica_paulino.store.Presentacion');
        var storeCA = Ext.create('sisbotica_paulino.store.Categoria');
        ...
        var _obj = [{
            ...
            items: [{
                ...
                },
                {
                    ...
                    items: [{
                            xtype: 'form',
                            url: sisbotica_paulino.util.Rutas.vendedorGuardar,
