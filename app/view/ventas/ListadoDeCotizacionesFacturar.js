Ext.define('sisbotica_paulino.view.ventas.ListadoDeCotizacionesFacturar', {
    ...
    requires: [
        ...
        'Ext.form.field.*',
        'Ext.panel.Panel',
        'sisbotica_paulino.view.ventas.AccionesRegCotizacionesFacturar',
    ...
    initComponent: function () {
        var storeCotiFacturar    = Ext.create('sisbotica_paulino.store.CotizacionesFacturar');
