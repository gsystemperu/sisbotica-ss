...
Ext.define('sisbotica_paulino.view.ventas.ContenedorCotizaciones', {
  ...
  requires: [
    ...
    'sisbotica_paulino.view.ventas.AccionesContenedorCotizaciones',
    'sisbotica_paulino.view.ventas.RegistrarCotizacion'
  ],
  layout: {
    type: 'card',
    align: 'stretch',
