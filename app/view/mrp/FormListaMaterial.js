Ext.define('sisbotica_paulino.view.mrp.FormListaMaterial', {
    ...
    requires   : [
        ...
        'sisbotica_paulino.view.mrp.AccionesFormListaMaterial',
    ...
    initComponent: function() {
        ...
        var storeProducto     = Ext.create('sisbotica_paulino.store.Productos');
        //storeProducto.load();
    ...
    getFormularioProducto: function (storeUnidadMedida, storeProveedores,storeProducto) {
      _storeDetListaMateriales = Ext.create('sisbotica_paulino.store.DetListaMateriales', {});
      storeProducto.load();
      var obj = [
        {
          xtype:'hiddenfield',
