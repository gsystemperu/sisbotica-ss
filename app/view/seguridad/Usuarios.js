...
Ext.define('sisbotica_paulino.view.seguridad.Usuarios', {
  extend: 'Ext.panel.Panel',
  xtype: 'wusuarios',
  requires: [
    'sisbotica_paulino.view.seguridad.UsuariosController',
    'sisbotica_paulino.view.seguridad.UsuariosModel'
  ],
  ...
  initComponent: function () {
    u = Ext.create('sisbotica_paulino.store.Usuarios');
    me = this;
    Ext.apply(this, {
      items: [{
        title: 'Registros',
        ...
        items: [{
          ...
          url: sisbotica_paulino.util.Rutas.actualizarUsuario,
          defaults: {
            xtype: 'textfield'
          },
  ...
  getFormularioProveedor: function () {
    s = Ext.create('sisbotica_paulino.store.Perfiles');
    var obj = [
      {
        xtype: 'hiddenfield',
        name: 'id',
