Ext.define('sisbotica_paulino.view.conf.configEmpresa', {
  ...
  requires: [
    ...
    'sisbotica_paulino.view.conf.configEmpresaController'
  ],
  margin: 30,
  autoScroll: true,
  controller: 'acciones-empresa',
  url: sisbotica_paulino.util.Rutas.actualizarEmpresa,
  layout: {
    type: 'vbox',
    pack: 'start',
    align: 'stretch'
    ...
    Ext.Ajax.request({
      ...
      success: function (response) {
        ...
        if (ob.imagen == '0') {
          ...
          Ext.ComponentQuery.query('#imgemp')[0].setSrc(
            sisbotica_paulino.util.Rutas.srcimagenes + 'logo.jpg?_=' + (new Date().getTime())
          )
  ...
  getFormularioEmpresa: function () {
    s = Ext.create('sisbotica_paulino.store.Series');
    t = Ext.create('sisbotica_paulino.store.Ticketeras');
    i = Ext.create('sisbotica_paulino.store.Tiendas');
    d = Ext.create('sisbotica_paulino.store.DocumentoVenta');
    var obj = [
