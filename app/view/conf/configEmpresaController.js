Ext.define('sisbotica_paulino.view.conf.configEmpresaController', {
    ...
    onClickEliminarTienda: function (btn) {
      ...
      if(Ext.isNumber(r.get('id')))
          sisbotica_paulino.util.Util.ajax(sisbotica_paulino.util.Rutas.tiendaEliminar,data,d)
      else
          d.remove(r);
    ...
    onClickEliminarSerie:function(btn){
      ...
      if(Ext.isNumber(r.get('id')))
          sisbotica_paulino.util.Util.ajax(sisbotica_paulino.util.Rutas.serieEliminar,data,d)
      else
          d.remove(r);
    },
    onClickEliminarTicketera:function(btn){
      ...
      if(Ext.isNumber(r.get('id')))
          sisbotica_paulino.util.Util.ajax(sisbotica_paulino.util.Rutas.ticketeraEliminar,data,d)
      else
          d.remove(r);
    },
