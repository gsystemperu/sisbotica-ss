...
Ext.define('sisbotica_paulino.view.conf.AccionesRegConfig', {
    ...
    onClickEliminarBanco:function(btn){
        me = this;
        Ext.Ajax.request({
                url: sisbotica_paulino.util.Rutas.bancoEliminar,
    ...
    onSelectedCategoria : function( grid, record, index, eOpts ) {this.lookupReference('frmCategoria').loadRecord(record)},
     ...
     onClickEliminarCategoria:function(btn){
        me = this;
        Ext.Ajax.request({
                url: sisbotica_paulino.util.Rutas.categoriaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarColor:function(btn){
         me = this;
        Ext.Ajax.request({
                url: sisbotica_paulino.util.Rutas.colorEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarMedida:function(btn){
         me = this;
        Ext.Ajax.request({
                url: sisbotica_paulino.util.Rutas.medidaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarUnidadMedida:function(btn){
          ...
          me = this;
        Ext.Ajax.request({
                url: sisbotica_paulino.util.Rutas.unidadMedidaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarTipoProducto:function(btn){
          me = this;
        Ext.Ajax.request({
                url: sisbotica_paulino.util.Rutas.tipoProductoEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarPresentacion:function(button){
      var rec = button.getWidgetRecord();
          if (rec) {
             Ext.Ajax.request({
                 url :sisbotica_paulino.util.Rutas.presentacionEliminar,
                 params:{
    ...
    onClickEliminarForma:function(b){
        ...
        if (rec) {
               Ext.Ajax.request({
                   url :sisbotica_paulino.util.Rutas.formaFarmaceuticaEliminar,
                   params:{
                     idforma : rec.get('id')
                   },
                   success:function(response){
    ...
    onClickEliminarFormaPago:function(button){
      ...
      if (rec) {
             Ext.Ajax.request({
                 url :sisbotica_paulino.util.Rutas.formaPagoEliminar,
                 params:{
    ...
    onClickEliminarModoEntrega:function(button){
      var rec = button.getWidgetRecord();
        if (rec) {
             Ext.Ajax.request({
                 url :sisbotica_paulino.util.Rutas.modoEntregaEliminar,
                 params:{
    ...
    onClickEliminarMarca:function(btn){
        me = this;
        Ext.Ajax.request({
                url: sisbotica_paulino.util.Rutas.marcaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarModelo:function(btn){
        me = this;
        Ext.Ajax.request({
                url: sisbotica_paulino.util.Rutas.modeloEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
