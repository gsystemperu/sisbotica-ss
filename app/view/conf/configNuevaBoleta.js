Ext.define('sisbotica_paulino.view.conf.configNuevaBoleta', { //**CAMBIAR
        extend: 'Ext.panel.Panel',
        xtype: 'wnuevaboleta', //**CAMBIAR
        alias: 'widget.wnuevaboleta', //**CAMBIAR
        requires: [
            'Ext.layout.container.HBox',
            'sisbotica_paulino.view.conf.configNuevaBoletaController',
            'Ext.grid.*',
            'Ext.grid.column.*',
            'Ext.form.field.*'
        ],
        ...
        initComponent: function () {
            st = Ext.create('sisbotica_paulino.store.TiendaDocumentosVentaAsignados');
            d  = Ext.create('sisbotica_paulino.store.TiendaDocumentosVenta');
