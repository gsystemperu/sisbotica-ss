Ext.define('sisbotica_paulino.view.conf.configNuevaTicketera', { //**CAMBIAR
        extend: 'Ext.panel.Panel',
        xtype: 'wnuevaticketera', //**CAMBIAR
        alias: 'widget.wnuevaticketera', //**CAMBIAR
        requires: [
            'Ext.layout.container.HBox',
            'sisbotica_paulino.view.conf.configNuevaTicketeraController',
            'Ext.grid.*',
            'Ext.grid.column.*',
            'Ext.form.field.*'
        ],
        ...
        initComponent: function () {
            st = Ext.create('sisbotica_paulino.store.TiendaTicketerasAsignadas');
            d  = Ext.create('sisbotica_paulino.store.TiendaTicketeras');
