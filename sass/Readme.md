...
folder are mapped to the application's root namespace, 'sisbotica_paulino'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "sisbotica_paulino"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'sisbotica_paulino' in the same way
as `"sisbotica_paulino/sass/src"`.
